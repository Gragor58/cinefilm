                ...
                <div class="row">
                    <?php
                        for($i = 0; $i < count($allData); $i++){
                            echo '<div class="col-4"><a class="text-decoration-none" href="index.php?page='. $allData[$i]["id"] .'"><div class="zoom"><img src="public/images/trailer-'. $allData[$i]["id"] .'.jpg" alt="affiche film"
                            class="affiches"></div>
